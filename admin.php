                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-warning btn-aksi" data-bs-toggle="modal" data-bs-target="#update<?= $id_user; ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>

                                                <button type="button" class="btn btn-danger btn-aksi" data-bs-toggle="modal" data-bs-target="#hapus<?= $id_user; ?>">
                                           ...
                                           <!-- Update Modal -->
                                            <div class="modal" id="update<?= $id_user; ?>">
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <br>
                                                        <input type="password" name="passwordbaru" value="<?= $password; ?>" class="form-control" placeholder="Password" required>
                                                        <br>
                                            ...
                                            <!-- Hapus Modal -->
                                            <div class="modal" id="hapus<?= $id_user; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
