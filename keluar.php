...
include('koneksi.php');
include('cek.php');
// Ambil data untuk chart line barang keluar
$ambilChart = mysqli_query($conn, 
"SELECT tanggal_keluar, SUM(qty) AS total_keluar 
 FROM keluar 
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-line"></i> Grafik Barang Keluar
                            </div>
                            <div class="card-body">
                                <canvas id="chartKeluar" width="100%" height="30"></canvas>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <?php
                                         if(isset($_POST['filter_tgl'])){
                                            ...
                                            and tanggal_keluar BETWEEN '$mulai' and DATE_ADD('$selesai', INTERVAL 1 DAY) order by id_keluar DESC");
                                            }else{
                                                $ambilsemuadatastok = mysqli_query($conn, "select * from keluar k, stok s where s.id_barang = k.id_barang");
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $img; ?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning btn-aksi" data-bs-toggle="modal" data-bs-target="#update<?= $idk; ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>

                                                <button type="button" class="btn btn-danger btn-aksi" data-bs-toggle="modal" data-bs-target="#hapus<?= $idk; ?>">
                                               ...
                                               <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" name="updatebrgklr">Update</button>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <br>
                                                        <div class="modal-footer">
                                                        <button type="submit" class="btn btn-primary" name="hapusbrgklr">Hapus</button>
                                                        <br>
                                                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                                        </div>
